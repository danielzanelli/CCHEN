...
class Ui_AgregarCanal(object):
    def setupUi(self, AgregarCanal):
        ...
        self.osciloscopio.setGeometry(QRect(210, 150, 121, 21))
        ...
        self.label_3.setGeometry(QRect(60, 210, 151, 20))
        self.canal = QComboBox(AgregarCanal)
        self.canal.setObjectName(u"canal")
        self.canal.setGeometry(QRect(210, 210, 121, 21))
