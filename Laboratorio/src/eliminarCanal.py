...
class Ui_EliminarCanal(object):
    def setupUi(self, EliminarCanal):
        ...
        self.nombre.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.osciloscopio.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.canal.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        self.label_5 = QLabel(EliminarCanal)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(50, 190, 111, 20))
        self.label_5.setFont(font2)
        self.label_6 = QLabel(EliminarCanal)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(50, 220, 111, 20))
        self.label_6.setFont(font2)
        self.datapoints = QLabel(EliminarCanal)
        self.datapoints.setObjectName(u"datapoints")
        self.datapoints.setGeometry(QRect(160, 220, 221, 20))
        self.datapoints.setFont(font2)
        self.datapoints.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
    ...
    def retranslateUi(self, EliminarCanal):
        ...
        self.label_6.setText(QCoreApplication.translate("EliminarCanal", u"Datapoints", None))
        self.datapoints.setText("")
    # retranslateUi
